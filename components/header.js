class CustomHeader extends HTMLElement {
    ...
    constructor() {
        ...
        searchboxForm.setAttribute('action', 'https://lucidu.cn/results');
        ...
        iconButton2.addEventListener('click', event => {
    ...
    connectedCallback() {
        ...
        this.mobileTopbarHeaderEndpoint.addEventListener('click', event => {
            window.location.href = 'https://lucidu.cn';
        });
        ...
        const updateScrollDir = () => {
            ...
            if (scrollY > lastScrollY) {
                ...
                const outEvent = new CustomEvent('in');
                this.dispatchEvent(outEvent);
                this.header.style.boxShadow = 'none';
    ...
    attributeChangedCallback(attrName, oldVal, newVal) {
        if (attrName === 'type') {
            ...
            this.searchboxForm.appendChild(input);
        } else if (attrName === "disable-scroll") {
