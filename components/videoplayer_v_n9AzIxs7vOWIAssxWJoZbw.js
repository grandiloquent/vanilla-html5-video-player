...
class CustomVideoPlayer extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.overlay = this.root.querySelector('.overlay-portrait');
        this.progressBar = this.root.querySelector('#progress-bar');
        this.timeFirst = this.root.querySelector('.time-first');
        this.play = this.root.querySelector('.player-control-play-pause-icon');
        this.path = this.play.querySelector('path');
        ...
        this.controlsBottom = this.root.querySelector('.player-controls-bottom');
        this.playerControlsContent = this.root.querySelector('.player-controls-content');
        this.fullscreenIcon = this.root.querySelector('.fullscreen-icon');
        this.playerControlContainer = this.root.querySelector('.player-control-container');
        this.playerControlsBackground = this.root.querySelector('.player-controls-background');
        this.player = this.root.querySelector('.player');
        this.html5VideoPlayer = this.root.querySelector('.html5-video-player');
        ...
        this.video.addEventListener('emptied', ev => {
            console.log('emptied')
        })
        ...
        this.video.addEventListener('loadstart', ev => {
        ...
        this.video.addEventListener('seeking', ev => {
            console.log('seeking')
        })
...
`
    ...
    adjustVideoSize() {
        ...
        console.log(`开始 adjustVideoSize: this.video.videoWidth = ${this.video.videoWidth},
...
window.innerHeight = ${window.innerHeight}`);
        ...
        console.log(`结束 adjustVideoSize: ratio = ${ratio},
height = ${height}`);
    }
    hideControls() {
        this.overlay.classList.remove('fadein');
